...
export default function Banner(){
    return(
      ...
      <Meteors number={10} />      
        <div> 
        <h2 className="w-8/12 py-6 text-7xl m-auto font-semibold text-gray-700 dark:text-[#d4d4d4]">
